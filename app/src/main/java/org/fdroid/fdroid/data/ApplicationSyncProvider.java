...
public class ApplicationSyncProvider extends FDroidProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String customSelection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (MATCHER.match(uri)) {
            ...
            case CODE_SINGLE:
                customSelection = ApplicationSyncTable.Cols.APP_ID + "=?";
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (MATCHER.match(uri)) {
            ...
            case CODE_SINGLE:
                ...
                selection = ApplicationSyncTable.Cols.APP_ID + "=?";
                selectionArgs = new String[]{String.valueOf(uri.getLastPathSegment())};
                return updateApplicationSyncTable(uri, contentValues, selection, selectionArgs);
            default:
    ...
    private int updateApplicationSyncTable(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        ...
        if (contentValues.containsKey(ApplicationSyncTable.Cols.APP_ID)) {
            String name = contentValues.getAsString(ApplicationSyncTable.Cols.APP_ID);
            if (name == null) {
        ...
        int rowsUpdated = db().update(ApplicationSyncTable.Cols.APP_ID, contentValues, selection, selectionArgs);
    ...
    public static final class Helper {
        ...
        public static long ensureExists(Context context, String app) {
            ...
            if (id <= 0) {
                ...
                values.put(ApplicationSyncTable.Cols.APP_ID, app);
        ...
        public static long getAppIdNum(Context context, String app) {
            String[] projection = new String[]{ApplicationSyncTable.Cols.APP_ID};
        ...
        public static List<String> apps(Context context) {
            ...
            final String[] projection = {ApplicationSyncTable.Cols.APP_ID};
